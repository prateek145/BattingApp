                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <div class="col-12">
                            <div class="card recent-sales overflow-auto">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">My Bets</h5>
                                    <form>
                                        <div class="row pb-3">
                                            <div class="col-3">
                                        ...
                                        <div class="row pb-3">
                                            ...
                                            <div class="col-3">
                                                <label for="inputPassword5" class="form-label">Bets Type</label>
                                                <select class="form-select" aria-label="Default select example">
                                                    <option selected>Select Bets Type</option>
                                                    <option value="1">All</option>
                                                    <option value="2">Matched Bets</option>
                                                    <option value="3">UnMatched Bets</option>
                                                </select>
