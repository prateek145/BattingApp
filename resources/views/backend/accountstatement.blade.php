                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <div class="col-12">
                            <div class="card recent-sales overflow-auto">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Account Statement <span class="badge text-bg-success ">CSV</span>
                                        <span class="badge text-bg-primary">Excel</span> <span
                                            class="badge text-bg-danger">Pdf</span>
                                    </h5>
                                    ...
                                    <table class="table table-borderless datatable">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row"><a href="#">06/02/2023, 4:24 PM</a></th>
                                                <td><span class="badge bg-success">D|W Cash</span></td>
                                            ...
                                            <tr>
                                                <th scope="row"><a href="#">06/02/2023, 7:57 AM</a></th>
                                                <td><span class="badge bg-danger">D|W Point</span></td>
                                                <td>Credit [Cash] Withdraw till 31/10/2022 21:08:49:107</td>
                                                <td><a href="#" class="text-primary">20,284.72</a></td>
                                                <td>100.00</td>
                                                <td>210.55</td>
                                            </tr>
                                            <tr>
                                                <th scope="row"><a href="#">31/10/2022, 9:08 PM</a></th>
                                                <td><span class="badge bg-primary">P|L Market </span></td>
                                                <td>Backup-System-26 March 2022-Casino Profit Loss</td>
                                                <td><a href="#" class="text-primary">20,292.01</a></td>
                                                <td>-</td>
                                                <td>798.51</td>
                                            </tr>
                                            <tr>
                                                <th scope="row"><a href="#">06/02/2023, 4:24 PM</a></th>
                                                <td><span class="badge bg-success">D|W Point</span></td>
                                                <td>Deposit Credit</td>
                                                <td><a href="#" class="text-primary"></a></td>
                                                <td>100.00</td>
                                                <td>210.55</td>
